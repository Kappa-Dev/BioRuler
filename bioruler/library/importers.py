...
class BioPaxActionGraphImporter():
    ...
    #             agent_nodes.append(fam_s)
    #             agent_nodes.append(fam_t)
    ...
    # def convert_collection_complex(self, complexes):
    #     agent_nodes = []
    #     structural_edges = []

    #     for complex_id, data in complexes.items():
    #         complex_node = self.data_.complex_to_node(complex_id)
    #         agent_nodes.append(complex_node)

    #         # Create flag nodes
    #         if "flag" in data.keys():
    #             for flag in data["flags"]:
    #                     flag_node = self.data_.flag_to_node(complex_id, flag)
    #                     if flag_node is not None:
    #                         agent_nodes.append(flag_node)
    #                         structural_edges.append(
    #                             edge_from_ids(
    ...
    #         if "residue" in data.keys():
    #             for residue in data["residues"]:
    #                 residue_node = self.residue_to_node(complex_id, residue)
    #                 if residue_node is not None:
    #                     agent_nodes.append(residue_node)
    #                     structural_edges.append(
    #                         edge_from_ids(
    ...
    def import_model(self, filename, ignore_families=False):
        ...
        # for s, t in self.metamodel_.edges():
        #     print(s, t)
        ...
        # graph["nodes"] += nodes
        # graph["edges"] += edges
        # nodes, edges = self.convert_collection_complex(agents["complexes"])
        # graph["nodes"] += nodes
        # graph["edges"] += edges
        ...
        # res_graph = TypedDiGraph(metamodel_AG)
